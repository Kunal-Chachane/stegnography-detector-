...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Update last login (optional, if you have a public.users table or via trigger)
            // Supabase handles auth.users automatically, so we don't necessarily *need* to manually update a public profile table here unless we want to. Let's redirect directly to dashboard.
