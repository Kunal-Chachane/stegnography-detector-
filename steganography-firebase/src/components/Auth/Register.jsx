...
export default function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            // Supabase optionally requires email verification depending on dashboard settings
            alert("Registration successful! (If you don't automatically log in, please check your email for a verification link based on Supabase project settings.)");
            navigate('/dashboard');
        } catch (err) {
